...
public class RegisterNoticeDocRequest {
	...
	@Schema(description = "노출 여부 플래그", defaultValue = "Y")
	private FlagType displayFlag;				
	
	@Schema(description = "상단 고정 여부 플래그", defaultValue = "N")
	private FlagType pinFlag;					

	@Schema(description = "게시 상시 여부 플래그", defaultValue = "N")
