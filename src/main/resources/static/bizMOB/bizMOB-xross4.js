 ...
 *   _aFileList: [{
 *     _sURI: 'https://example.com/files/document.pdf',
 *     _sDirectory: '{external}/download/document.pdf'
 *   }],
 *   _sMode: 'foreground',
 *   _sProgressBar: 'full',
 *   _fCallback: function(response) {
 ...
 * bizMOB.File.download({
 *   _aFileList: [
 *     { _sURI: 'https://example.com/file1.jpg', _sDirectory: '{external}/images/file1.jpg' },
 *     { _sURI: 'https://example.com/file2.jpg', _sDirectory: '{external}/images/file2.jpg' }
 *   ],
 *   _sMode: 'background',
 *   _sProgressBar: 'each',
 *   _fCallback: function(response) {
 ...
 * bizMOB.File.upload({
 *   _aFileList: [{
 *     _sSourcePath: '{internal}/photos/photo.jpg',
 *     _sFileName: 'photo.jpg'
 *   }],
 *   _fCallback: function(response) {
 *     if (response.result && response.list[0].result) {
 ...
 * bizMOB.File.upload({
 *   _aFileList: [
 *     { _sSourcePath: '{internal}/documents/report.pdf', _sFileName: 'report.pdf' },
 *     { _sSourcePath: '{internal}/images/chart.png', _sFileName: 'chart.png' }
 *   ],
 *   _fCallback: function(response) {
 ...
 * @param {String} _sUserId 푸시키를 등록할 사용자 아이디.
 ...
 * 푸시 알람 수신여부 설정
 *
 * @param {String} _sUserId 푸시 알림 설정을 등록할 사용자 아이디.
 ...
 * 푸시 알람 수신여부 조회
 *
 * @param {String} _sUserId 푸시 알림 설정을 조회할 사용자 아이디.
 * @param {Boolean} _bProgressEnable  (Default:true) 푸시 알람 설정 요청시 화면에 progress 표시 여부( true 또는 false )
 * @param {Function} _fCallback 결과를 받아 처리할 callback 함수.
 * @callback _fCallback
 ...
 * @param {String} _sUserId 푸시 메세지를 조회할 사용자 아이디.
 ...
 * SQL쿼리문을 실행
 *
 * @param {String} _sQuery 실행할 SQL 쿼리문.
